...
echo -e "$$ export KITTYCAD_CLI_SHA256=\"`cat $(BUILDDIR)/$(NAME)-$(1)-$(2).sha256 | awk '{print $$1}'`\"\n\n" >> $(BUILDDIR)/README.md;
echo -e "# Download and check the sha256sum." >> $(BUILDDIR)/README.md;
echo -e "$$ curl -fSL \"https://dl.kittycad.io/releases/cli/$(VERSION)/$(NAME)-$(1)-$(2)\" -o \"/usr/local/bin/kittycad\" \\" >> $(BUILDDIR)/README.md;
